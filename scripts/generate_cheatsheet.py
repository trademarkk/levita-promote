...
story = [
    ...
    p("Коротко повтори правила перед сменой. Твоя задача - познакомить женщину с LEVITA, заинтересовать и подсказать удобный следующий шаг, а не продавать абонемент.", subtitle),
]
