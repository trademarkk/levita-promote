...
story += [
    ...
    Spacer(1, 3 * mm),
    banner("ЛИЧНЫЕ QR-КОДЫ", "Для SMS и MAX-бота у тебя будут личные QR-коды. Покажи нужный код клиентке, помоги открыть официальный канал и не вводи данные за неё. QR-коды выдают тебе на весь период работы."),
    PageBreak(),
]
