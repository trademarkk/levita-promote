...
survey_cards = Table([[ 
    card("Есть интерес", "«Спасибо! По вашим ответам Вам может подойти ... По этому сертификату для Вас - 2 бесплатных групповых занятия. Можно выбрать удобный способ записи»", GOLD_SOFT, 85 * mm),
