    ...
    return (
      <section className="content-section narrow">
        ...
        <div className="survey-decision">
          <article className="yes"><span>Есть интерес</span><h3>Предложи следующий шаг</h3><p>Клиентка ответила «да» или «возможно» на последний вопрос, хочет начать, называет интересное направление или задаёт вопросы о клубе.</p><blockquote>«Спасибо! По вашим ответам Вам может подойти … По этому сертификату для Вас — 2 бесплатных групповых занятия. Хотите выбрать удобный способ записи?»</blockquote></article>
