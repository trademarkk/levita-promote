...
const KRASNODAR_STUDIOS = [
  "ул. им. В. Н. Мачуги, 4",
  "ул. Ставропольская, 174/1",
  "ул. Красная, 139",
  "ул. Кореновская, 2",
  "ул. им. П. Метальникова, 42",
  "ул. Мира, 1",
  "ул. 1 Мая, 196/1",
];
...
const difficultSituations = [
  ...
  },
  {
    ...
    options: [
      ...
      "«В VK-боте можно выбрать любой удобный адрес LEVITA в Краснодаре»",
    ],
    correct: 2,
...
const testBank: TestQuestion[] = [
  ...
  { id: "studio", question: "Где клиентка выбирает удобную студию?", options: ["В официальном VK-боте LEVITA", "В бумажном опроснике", "В телефоне промоутера", "После покупки абонемента"], correct: 0, explanation: "Бот предлагает выбрать любой удобный адрес LEVITA в Краснодаре." },
  ...
  if (active === 1) {
    return (
      <section className="content-section wide">
        ...
        <AudienceCarousel />
        <div className="decision-rule"><strong>Формула выбора</strong><span>Выглядит примерно на 25+</span><i>+</i><span>Не разговаривает по телефону</span><i>+</i><span>Не спешит и находится в безопасном месте</span><i>=</i><b>Можно поздороваться и завести диалог</b></div>
  ...
  if (active === 5) {
    return (
      <section className="content-section narrow">
        ...
        <ScriptCard label="Фраза для перехода">«Есть три удобных варианта: можно записаться через официальный VK-бот, отправить SMS по моему QR-коду или взять листовку и вернуться к этому позже. Как будет удобнее?»</ScriptCard>
        ...
        <div className="lead-methods">
          ...
          <article className="lead-method featured">
            ...
            <ul className="studio-list">{KRASNODAR_STUDIOS.map((studio) => <li key={studio}>{studio}</li>)}</ul>
            <small>Подсказывай, куда нажать, но не забирай телефон и не переписывай данные.</small>
          </article>
          <article className="lead-method">
        ...
        <div className="bot-grid">
          ...
          <div className="bot-steps">
            ...
            <Rule number="03" title="Выберите студию">Клиентка сама выбирает любой удобный адрес LEVITA в Краснодаре.</Rule>
