...
const testBank: TestQuestion[] = [
  ...
  { id: "pay", question: "За что промоутеру начисляется оплата?", options: ["За каждый разговор на улице", "За валидный лид и посещение пробного", "За количество выданных листовок", "Только за сканирование QR-кода"], correct: 1, explanation: "Оплата идёт отдельно за валидный лид и за посещение клиенткой пробного занятия." },
      ...
      <>
        ...
        <section className="content-section">
          ...
          <div className="benefit-grid">
            ...
            <article><span>02</span><h3>Понятная оплата</h3><p>Оплата идёт отдельно: за валидный лид и за посещение клиенткой пробного занятия.</p></article>
  ...
  if (active === 5) {
    return (
      <section className="content-section narrow">
        ...
        <div className="pay-note"><div><span>Личный QR</span><p>Помогает связать заявку с тобой.</p></div><div><span>Валидный лид</span><p>Оплачивается отдельно: есть дозвон, ответ и понимание цели звонка.</p></div><div><span>Посещение</span><p>Отдельная оплата — когда клиентка посетила пробное занятие. Повтор не оплачивается, бывшая клиентка оплачивается.</p></div></div>
      </section>
    );
  }
