...
const dialogues: Dialogue[] = [
  {
    ...
    messages: [
      ...
      { role: "promoter", text: "Отсканируйте мой личный QR-код: откроется официальный VK-бот LEVITA. Нажмите «Записаться», выберите удобную студию и заполните запись прямо в своём телефоне." },
      { role: "client", text: "Хорошо, давайте. Я выбрала студию на Мачуги." },
      { role: "promoter", text: "Отлично, запись готова! Вот сертификат, чтобы информация осталась у вас. Будем рады видеть вас в LEVITA." },
    ],
  ...
  },
  {
    ...
    subtitle: "Без контакта, но всё сделано правильно",
    outcome: "neutral",
    messages: [
...
const surveyDialogues: Dialogue[] = [
  ...
  },
  {
    ...
    note: "Опрос не обязан закончиться контактом. При ясном отсутствии интереса благодарим и не отдаём листовку.",
  },
  {
...
const difficultSituations = [
  ...
  },
  {
    ...
    correct: 1,
    feedback: "Бывшая клиентка считается оплачиваемым контактом. Детали её возвращения уточнит администратор.",
  ...
  },
  {
    ...
    correct: 2,
    feedback: "Безопасность важнее контакта. Не доказываем свою правоту и не продолжаем разговор.",
...
const testBank: TestQuestion[] = [
  ...
  { id: "follow", critical: true, question: "Можно ли идти следом после отказа?", options: ["Да, если не дольше минуты", "Да, если говорить спокойно", "Нет, контакт уже закончен", "Иногда, если мало контактов"], correct: 2, explanation: "Никогда не преследуй человека." },
  ...
  { id: "valid", critical: true, question: "Когда оплачивается контакт?", options: ["Клиентка оставила номер и ждёт звонка, но ещё не поняла, зачем ей звонят", "Клиентка взяла листовку", "Дозвонились: клиентка поняла, что такое LEVITA и зачем ей звонят", "Клиентка купила любой абонемент"], correct: 2, explanation: "Оплата за контакт начисляется, когда до клиентки дозвонились и она понимает, что такое LEVITA и почему ей звонят." },
  ...
  { id: "bot-finish", question: "Достаточно ли просто отсканировать QR-код?", options: ["Да, контакт уже готов", "Нет, нужно завершить запись в боте", "Да, если взяли листовку", "Нет, сначала нужен телефон промоутера"], correct: 1, explanation: "Помоги дойти до завершения записи, не забирая телефон у клиентки." },
  ...
  { id: "former", question: "Оплачивается ли контакт бывшей клиентки LEVITA?", options: ["Да, такой контакт оплачивается", "Нет, ведь она уже знакома с клубом и ничего объяснять не нужно", "Только после покупки", "Решает сам промоутер"], correct: 0, explanation: "Бывшая клиентка считается оплачиваемым контактом." },
  ...
  { id: "territory", question: "Можно ли изменить территорию смены без согласования с куратором?", options: ["Да, если там больше людей и работа кажется выгоднее", "Нет, сначала согласовать с куратором", "Да, после первого контакта", "Да, если предупредить после смены"], correct: 1, explanation: "Работай в обозначенной зоне. Изменение территории сначала согласуют с куратором." },
  { id: "shift", question: "Как обычно устроена смена?", options: ["Всегда длится восемь часов", "Слот в чате, обычно на 2–3 часа", "Начинается без сообщения", "Заканчивается после десяти контактов"], correct: 1, explanation: "Доступные слоты публикуются в рабочем чате." },
  ...
  { id: "older", question: "Женщина считает себя слишком взрослой. Что ответить?", options: ["Сказать, на сколько лет она выглядит", "У нас нет ограничений по возрасту, об этом можно не переживать. Нашему самому возрастному клиенту — 78 лет", "Согласиться с её сомнением", "Обещать быстрый результат"], correct: 1, explanation: "В LEVITA нет ограничений по возрасту: самому возрастному клиенту 78 лет." },
  ...
  { id: "pay", question: "За что промоутеру начисляется оплата?", options: ["За каждый разговор, даже если клиентка сразу отказалась", "150 ₽ за подтверждённый контакт и 350 ₽ за пришедшего клиента", "За количество выданных листовок", "Только за сканирование QR-кода и заполненную запись без разговора"], correct: 1, explanation: "Оплата идёт отдельно: 150 ₽ за контакт, которому дозвонились и который понимает, что такое LEVITA и почему ему звонят, и 350 ₽ за посещение этим клиентом пробного занятия." },
  ...
  { id: "survey-no-interest", critical: true, question: "По ответам спорт сейчас неинтересен. Что делать?", options: ["Уговорить на бесплатное занятие, даже если интереса нет", "Поблагодарить и попрощаться", "Отдать две листовки", "Попросить всё же открыть бот"], correct: 1, explanation: "Опрос может закончиться без контакта — это нормально." },
    ...
    <section className="content-section narrow">
      ...
      <div className="payout-calculator">
        <div className="payout-fields">
          <label className="payout-field"><span>Контакты, которым дозвонились</span><small>Клиентка понимает, что такое LEVITA и почему ей звонят</small><input type="number" min="0" max="50" value={leads} onChange={(event) => setLeads(Math.max(0, Math.min(50, Number(event.target.value) || 0)))} /></label>
        ...
        <div className="payout-result"><span>Возможная выплата</span><strong>{total.toLocaleString("ru-RU")} ₽</strong><p>{leads} × 150 ₽ за контакт + {visits} × 350 ₽ за посещение</p></div>
      </div>
      ...
      <>
        ...
        <section className="content-section">
          ...
          <div className="benefit-grid">
            ...
            <article><span>02</span><h3>Понятная оплата</h3><p>150 ₽ — за контакт, которому дозвонились и который понял, что такое LEVITA и почему ему звонят. Ещё 350 ₽ — если этот клиент пришёл на пробное занятие.</p></article>
      ...
      <section className="content-section narrow">
        ...
        <div className="bot-grid">
          ...
          <div className="bot-steps">
            ...
            <Rule number="02" title="Откройте запись">В боте клиентка нажимает «Записаться».</Rule>
        ...
        <div className="pay-note"><div><span>Личный QR</span><p>Помогает связать заявку с тобой.</p></div><div><span>Оплата за контакт</span><p>Она начисляется, когда клиентке дозвонились и она понимает, что такое LEVITA и почему ей звонят.</p></div><div><span>Оплата за посещение</span><p>Отдельная оплата — когда этот клиент посетил пробное занятие. Повтор не оплачивается, бывшая клиентка оплачивается.</p></div></div>
      </section>
    );
  }
    ...
    return (
      <section className="content-section narrow">
        ...
        <div className="timeline">
          <div><span>До выхода</span><ul><li>Выбери свободную смену в чате</li><li>Проверь территорию и точное время</li><li>Заряди телефон и проверь личный QR</li><li>Возьми листы опроса и сертификаты</li><li>Сохрани контакт куратора</li></ul></div>
